...
public class SalaController {
	...
	@PostMapping("/salvar")
	public String salvar(Sala sala, RedirectAttributes attr, @RequestParam("nome") String nome,
			@RequestParam("lotacao") int lotacao) {

		if (salaService.tratarEntradaDeDados(nome, lotacao)) {
			attr.addFlashAttribute("fail", "Todos os campos precisam estar preenchidos");
		} else {
