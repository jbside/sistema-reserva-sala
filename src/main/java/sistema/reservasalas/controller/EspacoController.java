...
public class EspacoController {
	...
	@PostMapping("/salvar")
	public String salvar(Espaco espaco, RedirectAttributes attr, @RequestParam("nome") String nome) {
		if (espacoService.tratarEntradas(nome)) {
			attr.addFlashAttribute("fail","O campo nome precisa estar preenchido");
		} else {
